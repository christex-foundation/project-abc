...
export const load: PageServerLoad = async ({ locals }) => {
	...
	const [submissions, earnings, recommendations, notifications, credits, creditTransactions] =
		await Promise.all([
	...
	return { submissions, earnings, recommendations, notifications, credits, creditTransactions };
};
