...
const DEV_USERS = [
	...
	{ email: 'company@fow.sl', password: 'Company1234!', name: 'Test Company', role: UserRole.COMPANY },
	{ email: 'freelancer@fow.sl', password: 'Freelancer1234!', name: 'Test Freelancer', role: UserRole.FREELANCER },
];
